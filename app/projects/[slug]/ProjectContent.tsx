        ...
        {slug === "vignette" && (
          ...
          <div className="mt-16">
            ...
            <div className="text-xs min-[480px]:text-sm text-gray-500 leading-[1.9] space-y-5">
              ...
              <p>{en
                ? "From the selected frames, the character region is extracted from the character frame, while the stage frame is captioned — together forming the foundation of the vignette illustration."
                : "選択されたフレームから、キャラクタフレームはキャラクタ領域が切り抜かれ、ステージフレームはキャプション化されることで、ヴィネットイラストの土台が作られる。"}
              </p>
              <p>{en
