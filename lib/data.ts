...
export const profile = {
  ...
  lab: "Smart Ambient Media チーム",
  email: "nmimy2000@keio.jp",
  googleScholar: "",
  researchGate: "",
  github: "",
  twitter: "",
  bio: "想像を創造する – Mayu Namai (2000–)",
  researchTheme: "動画からのヴィネットイラスト生成",
  interests: ["Visualization", "Illustration Generation", "Video Processing", "Computer Graphics"],
  updatedAt: "2026年2月",
};
